# Move
Move es una plataforma de eventos para conciertos,  cuenta con un cms, una aplicación móvil, y un servidor de notificaciones esta adentro del mismo cms.
## Requerimientos
* nodejs v8.9.4
* npm 5.6.0.
* nvm 0.33.8.
...
La aplicacion esta desarollado en ionic 1

## Entorno de Desarrollo cms
Este proyecto web esta desarrollado sobre angular js 
y el servidor de push notifications que que se encuentra dento del cms 
esta desarrollado en node
...
```
# clonar el cms sobre el servidor y ejecutar:
...
### Tienda google play console
Username               | Contraseña
----------             | -------------
app@mocionsoft.com     | mocion.2040

### Tienda Itunnes connec
Email                   | Contraseña
----------------------- | -------------
app@mocionsoft.com      | Mocion.2040
